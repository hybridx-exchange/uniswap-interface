...
import { CurrencyAmount, ETHER, SwapParameters, Token, Trade, TradeOptions, TradeType } from '@hybridx-exchange/uniswap-sdk'
...
export default function v1SwapArguments(trade: Trade, options: Omit<TradeOptions, 'feeOnTransfer'>): SwapParameters {
  ...
  if (inputETH && outputETH) throw new Error('ROSE to ROSE')
